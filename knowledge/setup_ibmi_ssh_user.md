...
❗ ```Log in as the user: SSHUSER1 and start a QShell session.  These steps should be run from the logged in user profile to make sure file permissions take successfully.```
```
STRQSH
```
